...
public final class ShortcutBadger {
    ...
    public static void applyCountOrThrow(Context context, int badgeCount) throws ShortcutBadgeException {
        System.out.println("notttttttttttttttif 1 "+sShortcutBadger);

        if (sShortcutBadger == null) {
            boolean launcherReady = initBadger(context);

            System.out.println("notttttttttttttttif 2 "+launcherReady);
        ...
        try {
            ...
            System.out.println("notttttttttttttttif 3 "+e);
