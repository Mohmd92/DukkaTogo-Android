...
public class RecyclerMostwantedAdapter extends RecyclerView.Adapter<RecyclerMostwantedAdapter.ViewHolder> {
    List<MostWanted> mValues;
    Context mContext;
    private ItemClickListener clickListener;
    APIInterface apiInterface;

    public RecyclerMostwantedAdapter(Context context, List<MostWanted> values) {
...
//        mListener=itemListener;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void setData(MostWanted item) {
            this.item = item;
            ...
            rel_add_to_card.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(text_add.getText().equals(mContext.getString(R.string.add_to_cart))) {
                        @SuppressLint("HardwareIds") String ID = Settings.Secure.getString(mContext.getContentResolver(),
                                Settings.Secure.ANDROID_ID);
                        System.out.println("HHHHHHHHHHHHhhssssw "+item.id+"   "+ID);
...
//                            Toast.makeText(context, "onFailure", Toast.LENGTH_SHORT).show();
    ...
    @Override
    public RecyclerMostwantedAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
